...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 relative overflow-hidden">
      <div className="absolute top-0 left-0 -z-10 h-[800px] w-full bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_100%)]" />
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-amber-500/8 blur-[120px] rounded-full -z-10" />
      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 pt-24 pb-16 md:pt-32 md:pb-24">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto gap-6 relative z-10">
            <FadeIn delay={0.1} yOffset={10}>
              <div className="rounded-full border border-amber-500/20 px-4 py-1.5 text-xs font-medium text-amber-600 dark:text-amber-400 bg-amber-500/8 backdrop-blur-sm">
            ...
            <FadeIn delay={0.2} yOffset={20}>
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight">
                Download files at{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-orange-400 to-amber-600 drop-shadow-sm">warp speed</span>
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={0.4} yOffset={20}>
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                <Button asChild size="lg" className="bg-gradient-to-r from-amber-500 to-orange-500 text-white hover:opacity-90 shadow-lg shadow-amber-500/25 px-8 rounded-full h-12 text-md w-full sm:w-auto border-0">
                  <Link href="/docs/installation">
                    Get Started
                    <ArrowRight className="ml-2 size-4" />
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="px-8 rounded-full h-12 text-md w-full sm:w-auto bg-background/50 backdrop-blur-sm border-border/50 hover:bg-amber-500/5">
        ...
        <section className="container mx-auto px-4 pb-24">
          <FadeIn delay={0.5} yOffset={30}>
            <div className="max-w-4xl mx-auto rounded-2xl border border-border/50 bg-background/40 backdrop-blur-xl shadow-2xl overflow-hidden ring-1 ring-white/5 relative">
...
+--------------------------------------------------------+`} />
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {features.map((f, i) => (
              <FadeIn key={f.title} delay={0.1 * i} yOffset={30} className="h-full">
                <Card className="h-full border-border/50 bg-background/50 backdrop-blur supports-backdrop-filter:bg-background/20 hover:border-amber-500/30 transition-colors group">
                  <CardHeader>
                    <div className="p-3 bg-amber-500/10 w-fit rounded-lg mb-4 group-hover:scale-110 group-hover:bg-amber-500/20 transition-all">
        ...
        <section className="border-t border-border/40 bg-muted/20 relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-64 bg-amber-500/10 blur-[100px] -z-10 rounded-full" />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <FadeIn>
                  ...
                  <Button asChild variant="outline" className="rounded-full bg-background/50 backdrop-blur-sm border-border/50 hover:bg-amber-500/5">
              ...
              <FadeIn delay={0.2}>
                <div className="relative group">
                  <div className="absolute -inset-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl blur-lg opacity-30 group-hover:opacity-50 transition duration-1000 group-hover:duration-200" />
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <div className="bg-muted/50 border border-border/50 backdrop-blur-sm rounded-xl p-6 font-mono text-sm w-full shadow-inner relative overflow-hidden">
                <div className="absolute top-0 right-0 p-4 opacity-5"><Terminal className="size-24" /></div>
              ...
              <p className="text-center text-muted-foreground mt-6 text-lg">
                Then run <code className="text-amber-500 font-mono bg-amber-500/10 px-2 py-1 rounded">grabr --help</code> to launch.
              </p>
            </div>
          </FadeIn>
        </section>
