        ...
        <section className="container mx-auto px-4 pt-24 pb-16 md:pt-32 md:pb-24">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto gap-6 relative z-10">
            <FadeIn delay={0.1} yOffset={10}>
              <div className="rounded-full border border-amber-500/30 px-4 py-1.5 text-xs font-medium text-amber-600 dark:text-amber-400 bg-amber-500/10 backdrop-blur-sm">
            ...
            <FadeIn delay={0.2} yOffset={20}>
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight">
                Download files at{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-300 drop-shadow-lg">warp speed</span>
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={0.4} yOffset={20}>
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                <Button asChild size="lg" className="bg-amber-500 text-white hover:bg-amber-600 shadow-lg shadow-amber-500/20 px-8 rounded-full h-12 text-md w-full sm:w-auto">
        ...
        <section className="container mx-auto px-4 pb-24">
          <FadeIn delay={0.5} yOffset={30}>
            <div className="max-w-4xl mx-auto rounded-2xl border border-border/50 bg-background/40 backdrop-blur-xl shadow-2xl overflow-hidden ring-1 ring-white/10 relative">
              <div className="absolute inset-0 bg-gradient-to-tr from-amber-500/5 via-transparent to-amber-500/5" />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <FadeIn delay={0.2}>
                <div className="relative group">
                  <div className="absolute -inset-1 bg-gradient-to-r from-amber-500 to-amber-300 rounded-xl blur opacity-25 group-hover:opacity-40 transition duration-1000 group-hover:duration-200" />
